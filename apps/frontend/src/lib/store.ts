...
export type AppView = 'chat' | 'projects' | 'project-detail' | 'customize';
      ...
      deleteConversation: (id) => {
        set(s => {
          ...
          const newActive = s.activeId === id
            ...
            : s.activeId;
          return { conversations: next, activeId: newActive };
        });
      },
